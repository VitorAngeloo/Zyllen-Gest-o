...
export function ProjectsOverview() {
    ...
    return <div className="space-y-8">
        ...
        {period && <>
            ...
            <section aria-label={copy.overviewTrips} className="space-y-4"><ListSectionHeader title={copy.overviewTrips} description={operationsCopy.scope} />
