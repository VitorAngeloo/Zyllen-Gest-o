...
import {
    ...
    ArrowLeft, ChevronRight, Paperclip, X, ImageIcon, VideoIcon, FileText,
} from "lucide-react";
    ...
    return (
        <div className="space-y-6">
            <PageHeader
                ...
                title="Meus Chamados"
                description="Acompanhe e gerencie seus chamados de suporte"
            ...
            <ListSectionHeader
                ...
                description="Selecione um chamado para consultar mensagens, anexos e andamento."
            />
            ...
            {loading ? (
                ...
                <EmptyState
                    ...
                    description="Quando precisar de suporte, registre a solicitação e acompanhe todo o atendimento por aqui."
                    action={<Button variant="highlight" onClick={() => setShowNewForm(true)}>Abrir primeiro chamado</Button>}
                />
            ) : (
                <RecordList>
                    {tickets.map((ticket) => {
                            ...
                            >
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <div className="flex shrink-0 items-center gap-3">
                                        <span className="text-xs font-medium" style={{ color: priorityCfg.color }}>{priorityCfg.label}</span>
