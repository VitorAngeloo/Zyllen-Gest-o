...
import { PANEL_IDS, PANEL_PERMISSION_OPTIONS } from '../panel.constants';
...
export function PanelMirrorSettings() {
    ...
    const views = userType === 'internal' ? PANEL_IDS.filter(id => PANEL_PERMISSION_OPTIONS[id].some(permission => hasPermission(permission))) : [];
