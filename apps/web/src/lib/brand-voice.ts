...
export const PROJECT_SERVICE_COPY = {
  ...
  company: 'Cliente', chooseCompany: 'Selecione o cliente', existingProject: 'Cadastro do projeto', newProject: 'Criar cadastro de projeto',
  name: 'Nome do projeto', marker: 'Marcador de modelo', noMarker: 'Sem marcador', newMarker: 'Novo marcador', addMarker: 'Adicionar marcador',
  ...
  sectors: 'Setores envolvidos (separados por vírgula)', travel: 'Requer viagem', relevant: 'Destaque para acompanhamento', notes: 'Observações',
...
export const TRIP_COPY = {
  ...
  title: 'Viagens', navigation: 'Viagens', description: 'Planeje deslocamentos e reúna os serviços atendidos em cada viagem.',
  ...
  loadError: 'Não foi possível carregar as viagens.', detailError: 'Não foi possível carregar a viagem ou as opções do cadastro.', empty: 'Nenhuma viagem encontrada. Cadastre uma viagem ou ajuste os filtros.',
...
export const OPERATIONS_DASHBOARD_COPY = {
  ...
  installations: 'Instalações concluídas', removals: 'Desinstalações concluídas', plannedTrips: 'Viagens previstas', completedTrips: 'Viagens realizadas',
  actualContext: 'Conclusão real no período', plannedContext: 'Saída prevista no período · ainda abertas',
  currentPlanned: 'Planejadas atualmente', inProgress: 'Em viagem atualmente',
