...
**Atualização de 21/09/2026:** saídas individuais e em lote por **Manutenção**, **Uso interno** e **Baixa** selecionam automaticamente os locais internos correspondentes, sem exigir cliente/projeto. **Perda** e **Uso** deixam de ser opções de motivo de saída, mantendo **Uso interno**. A saída individual também exige **Evento na timeline**. Baixa definitiva aguarda aprovação de outra pessoa; o patrimônio permanece consultável em **Baixa**, com condição `BAIXADO` e timeline. Saídas para clientes seguem exigindo estoque do cliente vinculado ao projeto. Saídas antigas sem destino específico passam por **Outros**, preservando local, movimento e timeline. A migração aditiva [20260921140000_internal_stock_destinations](../../apps/api/prisma/migrations/20260921140000_internal_stock_destinations/migration.sql) já foi aplicada à base compartilhada.
